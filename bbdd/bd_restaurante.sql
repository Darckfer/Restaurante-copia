...
-- Foreign key rol
ALTER TABLE `db_restaurante`.`camarero`
ADD CONSTRAINT `fk_id_rol` FOREIGN KEY (`rol`) REFERENCES `db_restaurante`.`roles` (`id_rol`) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- FOREIGN KEYS TABLA HISTORIAL
ALTER TABLE `db_restaurante`.`historial`
ADD INDEX `fk_id_camarero_idx` (`id_camarero` ASC) VISIBLE,
ADD INDEX `fk_id_mesa_idx` (`id_mesa` ASC) VISIBLE;;

ALTER TABLE `db_restaurante`.`historial`
ADD CONSTRAINT `fk_id_camarero` FOREIGN KEY (`id_camarero`) REFERENCES `db_restaurante`.`camarero` (`id_camarero`) ON DELETE NO ACTION ON UPDATE NO ACTION,
ADD CONSTRAINT `fk_id_mesa` FOREIGN KEY (`id_mesa`) REFERENCES `db_restaurante`.`mesa` (`id_mesa`) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- FOREIGN KEY TABLA MESA
ALTER TABLE `db_restaurante`.`mesa`
ADD INDEX `fk_id_Sala_idx` (`id_sala` ASC) VISIBLE;;

ALTER TABLE `db_restaurante`.`mesa`
ADD CONSTRAINT `fk_id_Sala` FOREIGN KEY (`id_sala`) REFERENCES `db_restaurante`.`sala` (`id_sala`) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- FOREIGN KEY TABLA TIPO SALA
ALTER TABLE `db_restaurante`.`sala`
ADD INDEX `fk_id_tipoSala_idx` (`id_tipoSala` ASC) VISIBLE;;

ALTER TABLE `db_restaurante`.`sala`
ADD CONSTRAINT `fk_id_tipoSala` FOREIGN KEY (`id_tipoSala`) REFERENCES `db_restaurante`.`tipo_sala` (`id_tipoSala`) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- Insert roles

INSERT INTO `roles` (`id_rol`, `nombre`)
VALUES(NULL,'Encargado'), (NULL,'Camarero');

-- Insert camareros
-- pwd: asdASD123
INSERT INTO `camarero` (`id_camarero`, `nombre`, `usuario`, `password`,`rol`)
VALUES(NULL,'Julio','Julio','$2y$10$9YAaDvpj8IDI7WRNVxVq6uYzMnCaUWDGMlU6LS.jv6dgpWcmqcswS',1),
(NULL,'Marc M','MarcM','$2y$10$9YAaDvpj8IDI7WRNVxVq6uYzMnCaUWDGMlU6LS.jv6dgpWcmqcswS',2),
(NULL,'Marc C','MarcC','$2y$10$9YAaDvpj8IDI7WRNVxVq6uYzMnCaUWDGMlU6LS.jv6dgpWcmqcswS',2),
(NULL,'Juanjo','Juanjo','$2y$10$9YAaDvpj8IDI7WRNVxVq6uYzMnCaUWDGMlU6LS.jv6dgpWcmqcswS',2);
...
-- Insert salas
INSERT INTO `db_restaurante`.`sala` (`id_tipoSala`, `nombre_sala`) VALUES ('1', 'Terraza principal');
INSERT INTO `db_restaurante`.`sala` (`id_tipoSala`, `nombre_sala`) VALUES ('1', 'Terraza este');
INSERT INTO `db_restaurante`.`sala` (`id_tipoSala`, `nombre_sala`) VALUES ('1', 'Terraza oeste');
INSERT INTO `db_restaurante`.`sala` (`id_tipoSala`, `nombre_sala`) VALUES ('2', 'Comedor 1 PB');
INSERT INTO `db_restaurante`.`sala` (`id_tipoSala`, `nombre_sala`) VALUES ('2', 'Comedor 2 P1');
INSERT INTO `db_restaurante`.`sala` (`id_tipoSala`, `nombre_sala`) VALUES ('3', 'Sala privada PB');
INSERT INTO `db_restaurante`.`sala` (`id_tipoSala`, `nombre_sala`) VALUES ('3', 'Sala privada 1 P1');
INSERT INTO `db_restaurante`.`sala` (`id_tipoSala`, `nombre_sala`) VALUES ('3', 'Sala privada 2 P1');
INSERT INTO `db_restaurante`.`sala` (`id_tipoSala`, `nombre_sala`) VALUES ('3', 'Sala privada 3 P1');
...
INSERT INTO `db_restaurante`.`mesa` (`id_sala`, `libre`, `num_sillas`) VALUES ('9', '0', '2');
-- Insert stock
INSERT INTO `db_restaurante`.`stock` (`sillas_stock`) VALUES ('30');